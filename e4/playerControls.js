...
videoElement.setAttribute("fullscreen", "true");
...
function openFullscreen(){
  console.log("fullscreen");
   if(document.fullscreenElement){
    ...
    fullscreenButton.style.backgroundImage = "url('./icons/fullscreen-line-1.svg')"
  } else {
...
/*https://www.veryicon.com/icons/miscellaneous/test-2/exit-full-screen-6.html  under free for personal and commercial use*/
